...
const PATHS: Record<IconName, ReactNode> = {
  // Delegate a task — a "compose" square-pen (write/create a task for the agent).
  delegate: (
    <>
  ...
  // Delegate / start a new task — a plus (the conventional "new / create" glyph).
  plus: (
    <>
      <path d="M5 12h14" />
      <path d="M12 5v14" />
  ...
  // A key — used by the API-key-gated empty state.
  key: (
    <>
